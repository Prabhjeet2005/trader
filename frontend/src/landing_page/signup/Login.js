    ...
    <>
      <div className="flex justify-center mt-24 mb-24">
        <form
          ...
          <div className="text-3xl mb-5 font-semibold">Login</div>
          ...
          <div>
            ...
            <button className="w-48 flex flex-col items-center p-2 text-white bg-orange-400 hover:bg-orange-600 hover:scale-110 rounded transition" onClick={handleGuest}>Guest <span>(Explore Without Login)</span></button>
